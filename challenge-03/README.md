...
*/
pessoa.nomeCompleto() // "Olá! Meu nome é Vitor Fernandes!"
...
pessoa.mostrarAndando = function(){
	...
	return pessoa.nome + " " + pessoa.sobrenome + ' não está andando no momento.'	    
    } 
return pessoa.nome + " " + pessoa.sobrenome + ' está andando no momento.'	
}

pessoa.mostrarAndando() // Vitor Fernandes não está andando no momento.

/*
Quantos metros a pessoa andou? (Use uma instrução para responder e comentários
inline ao lado da instrução para mostrar a resposta retornada)
*/
pessoa.mostrarMetros = function(){
    return pessoa.nome + " " + pessoa.sobrenome + ' andou' + pessoa.caminhouQuantosMetros + ' metros!'
}
...
*/
var frase = {frase1: "Olá, eu sou o ", frase2: " anos, ", frase3:  " metros!"}

pessoa.apresentacao = function (){
    if (pessoa.sexo === 'feminino'){
        frase.frase1 = "Olá, eu sou a";
